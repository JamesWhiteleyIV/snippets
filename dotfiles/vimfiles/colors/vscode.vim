...
call <sid>hi('pythonExceptions', s:cdBlueGreen, {}, 'none', {})
...
call <sid>hi('pythonModule', s:cdBlueGreen, {}, 'none', {})
call <sid>hi('pythonBuiltinObj', s:cdLightBlue, {}, 'none', {})
call <sid>hi('pythonBuiltin', s:cdBlue, {}, 'none', {})
...
call <sid>hi('pythonTripleQuotes', s:cdGreen, {}, 'none', {})
call <sid>hi('pythonEscape', s:cdGreen, {}, 'none', {})
call <sid>hi('pythonDecorator', s:cdYellow, {}, 'none', {})
call <sid>hi('pythonConstant', s:cdDarkBlue, {}, 'none', {})
call <sid>hi('pythonSymbol', s:cdFront, {}, 'none', {})
call <sid>hi('pythonFormatter', s:cdFront, {}, 'none', {})
